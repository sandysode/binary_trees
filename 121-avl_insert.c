...
/**
 * avl_insert - Inserts a val in an AVL Tree.
 *
 * @tree: A double pointer to root node of the AVL tree for inserting.
...
/**
 * avl_insert_recursive - Inserts a val into an AVL tree recursively.
 *
